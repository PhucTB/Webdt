        ...
        <div class="row_table">
            <form action="" method="post" id="tbl">
                ...
                <select name="" id="connect">
                    ...
                    <?php
                    $show_khachang = $brand->show_khachhang();
                    if ($show_khachang) {
                        while ($result = $show_khachang->fetch_assoc()) {
                    ?>
                    <option value="<?php echo $result['customer_id'] ?>"><?php echo $result['Tenkhachhang'] ?></option>
                    <?php
                        }
                    }
                    ?>
                ...
                <select name="" id="connect">
                    ...
                    <?php
                    $show_product = $brand->show_product();
                    if ($show_product) {
                ...
                <button class="custom-btn btn-4">Tuần</button>
                <button class="custom-btn btn-4">Tháng</button>
                <button class="custom-btn btn-4">Quý</button>
                <input class="custom-btn btn-4" type="submit" value="Tìm kiếm" class="button">
            </form>
        </div>
        <div class="row_table">
